...
export function MealRecordCreateScreen() {
  ...
  const initialDraft = useMemo(() => createEmptyDraftFromJapanNow(), []);
  const [draft, setDraft] = useState<MealRecordDraft>(initialDraft);
  ...
  }, [draft, isSignedIn, isSubmitting, mealRecordsApi, recipientId, router]);
  ...
  const onSubmit = useCallback(() => {
    ...
    Alert.alert('入力内容の確認', buildMealSummaryText(draft, recipient.name), [

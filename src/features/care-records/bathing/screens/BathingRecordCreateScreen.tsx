...
import {
  ...
  createEmptyBathingDraftFromJapanNow,
...
export function BathingRecordCreateScreen() {
  ...
  const initialDraft = useMemo(() => createEmptyBathingDraftFromJapanNow(), []);
  const [draft, setDraft] = useState<BathingRecordDraft>(initialDraft);
  ...
  }, [draft, isSignedIn, isSubmitting, bathingRecordsApi, recipientId, router]);
  ...
  const onSubmit = useCallback(() => {
    ...
    Alert.alert('入力内容の確認', buildBathingSummaryText(draft, recipient.name), [

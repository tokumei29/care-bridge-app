...
import { collectCareRecordMonthKeys } from '@/features/care-records/pdf/monthKeyUtils';

export function usePdfExportMonthKeys(recipientId: string | undefined) {
  ...
  const refresh = useCallback(async () => {
    ...
    try {
      ...
      const keys = collectCareRecordMonthKeys({
  ...
  return { monthKeys, loading, error, refresh };
}
